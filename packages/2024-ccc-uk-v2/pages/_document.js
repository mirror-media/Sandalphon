  ...
  return (
    <Html>
      <Head>
        ...
        <meta property="og:title" content={projectWording.ogTitle} />
        <meta property="og:image" content={projectWording.ogImage} />
        <meta property="og:image:secure_url" content={projectWording.ogImage} />
        <meta property="og:image:type" content="image/jpeg" />
        <meta
          property="og:description"
          content={projectWording.ogDescription}
        />

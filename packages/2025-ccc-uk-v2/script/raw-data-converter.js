  ...
  .reduce((first) => {
    return {
      ...
      text: {
        ...
        second: {
          title: `零線攻擊\n張乾琦見證無人機時代的烏俄戰爭`,
          pre: `從烏俄戰爭到以伊戰爭，宣告無人機時代的來臨。以前拿來拍婚禮、拍旅遊風景的空拍機，只消經過一點改裝，就搖身一變成了戰爭前線的偵察甚至攻擊武器。\n\n紀實攝影家張乾琦，從開戰以來，持續進行戰地紀實工作，第十次進入烏克蘭，他來到兩軍交戰最前沿的「零線」區域，並親身遭遇一架俄羅斯自殺式無人機追擊，生死一瞬間。\n\n以伊戰爭吸引多數媒體目光，國際社會的「烏克蘭疲勞」日益明顯，張乾琦仍一去再去。他語重心長地說：「我在烏克蘭所見證的，很可能預示我們眼前的未來。無人機、靜默和等待—這些並非遙遠的回聲。它們是實在的警告。」\n\n編按：零線（zero line）是前線的最前沿，並非實際存在的線，而是隨著戰事發展不斷變動想像的作戰區域。`,
          pairs: [
            {
              head: '',
              body: `凌晨三點四十七分，在赫爾松的聶伯河畔，我們的BMP-2步兵戰車猛然震動後，在零線之內停了下來。片刻之後，戰車上的三○毫米自動砲猛烈開火，一道道像是閃亮曳光彈的火光短暫劃破黑暗。隆隆的砲聲像敲擊的鋼鼓在我腦中迴響。車身因後座力而劇烈晃動。就在幾公尺外，我的新聞嚮導和我蹲伏在黑暗中—毫無掩蔽，每次震動都令我們畏縮。這一切持續不到一分鐘。\n\n「快上車，現在！動作快！」一名士兵大吼，我們急忙啟動車子，以九○公里的時速馳過漆黑一片、滿布地雷的地形。引擎轟鳴。金屬鏗鏘作響。每一個顛簸猛烈撞擊我們的脊椎，車身響著暴力的鼓聲。我們坐在近三○○加侖柴油和成箱尚未發射的三○毫米砲彈上頭。脆弱感令人窒息。只消一枚火箭，一切都將陷入火海。\n\n幾個小時後，回到基地，砲手才告訴我，我們遭到了一架俄羅斯自殺式無人機追擊。如果我們被擊中，無人機上的炸藥會炸穿戰車，這樣的撞擊會使柴油猛烈晃動，這篇報導就到此為止了。砲手咧嘴一笑，彷彿沒什麼大不了—對命運聳肩接受多過於恐懼。當時我並未聽到無人機的聲音。我只有感覺到速度、急迫感，以及受過求生訓練士兵的沉默不語。隆隆砲聲仍在我耳中迴盪。我在得知可能發生的狀況後，不禁背脊發涼。\n\n二○二五 年三月，我隨軍採訪烏克蘭第四○旅第一營多次進入零線的任務，包括兩次在聶伯河的部署行動。每次任務，由四名身著野戰偽裝服、步槍斜掛的海軍陸戰隊員，帶著可維持一個月的補給品登上橡皮艇。這條河不僅分隔了領土，也分隔了兩個世界—兩岸都布滿死亡。\n\n然而，儘管前線動盪依舊，全球的焦點卻已開始轉移。\n\n近幾個月，以色列和伊朗的衝突升級—以彼此互射飛彈和報復性的空襲為標誌—成了新聞頭條和全球政治焦點。這場危機可能引燃更廣泛的區域戰爭並牽扯全球強權捲入，獨占了國際外交的關注心力。這樣的轉變更加深了國際間所謂的「烏克蘭疲乏」。儘管烏克蘭戰事的慘烈程度與日俱增，媒體報導和國際關注卻已被分散。自二○二五年年初以來，俄羅斯逐步鞏固它的陣地，在多條戰線升高無人機作戰和砲擊，包括對民用目標的攻擊。這些攻擊在造成衝擊之前，往往悄無聲息，其破壞力巨大，嚴重打擊士氣。媒體的職責依然不變：要留下見證並提醒世界，這場戰爭遠未結束。\n\n於是，零線持續在演變。\n\n「零線」並非單一的地點，而是由部隊和地形所決定的變動概念。對步兵而言，它或許就在林木線之外的壕溝。對砲兵而言，它在有效射程範圍的邊緣。對特種部隊來說，它深入敵境之內。\n\n在札波羅熱，它的樣貌和在頓巴斯不同。沿著聶伯河，零線是河岸和島嶼—處處泥濘、滿布地雷—兩邊都在砲擊射程範圍內。零線沒有固定的地圖，它和戰爭本身一樣都會移動—還有伴隨而來的危險：猝不及防、毫不留情，而且往往難以察覺。\n\n跨越它，就進入了稍有猶豫便會致命的境地，沒有預警，也沒有第二次機會。唯有黑暗、命令，以及你隨車子搖晃前行的喘息聲。\n\n這類行動只在夜晚進行。不開車頭燈、也沒有手電筒—只有拖著橡皮艇的悍馬車的微弱車尾燈。悍馬車配備了無人機干擾器，由一名戴著夜視鏡的士兵駕駛，快速行過險惡的地形。在這種時刻，感覺一切都已暴露在外：不管是士兵、機器或地貌本身。你不知威脅來自何處。你感覺它就在蘆葦叢之外的某處移動。即使在一片漆黑之中，仍可清楚感受到危機。危險從未曾真正消散。\n\n在白天，同樣的士兵們持續不懈地接受訓練。我看著他們演練渡河、衝刺操練和裝設詭雷。他們發射火箭彈、迫擊砲，訓練應對混亂情況。他們在殘破的建築物裡研究數位地圖和座標—為將在黑夜裡展開的任務做準備。\n\n在任務與任務之間的空檔，他們會跟家人通話、查看Telegram，在臨時的基地裡洗衣服。不過大半時候他們在等待。等待著下一個任務。等待座標。聽取命令。戰爭的節奏並非持續的戰火。它是一長串的寂靜，由突如其來的行動打破。它是等待、觀望和準備。在長長的停頓中，故事浮現出來—有些透過述說，有些則在沉默中傳遞。\n\n代號「卡塔布」的四十二歲連長，和我們分享二○二二年赫爾松反擊戰的故事。報導裡的人多數不方便透露真實身分，只能使用代號。他奉命帶著一百名士兵守護一個戰略據點，經歷一波又一波的殘酷攻擊—頭頂砲彈呼嘯而過、步槍和機關槍火力粉碎了林木線，戰壕裡煙霧瀰漫。援軍晚了兩個小時抵達。在這之前，一則無線電訊息警告說：「兩輛俄軍坦克正朝你們而去。」\n\n卡塔布有高大的身材—身高一九○公分、體重約九○公斤—和一顆慷慨的心。煙硝瀰漫中，制服浸漫汗水和塵土，他把自己剩下的三個彈匣分了兩個給同袍。空氣充滿帶有血腥和火藥的金屬臭味。在這期間，他的大腿中彈。他已準備好一枚手榴彈，準備解決任何突破防線的俄羅斯人。但救兵趕到。他一瘸一跛走了出來，踩過戰友們殘缺的遺體，及混著血和灰燼的黏膩泥地。一百人之中，只有九人生還。話到一半，他的聲音哽咽，眼眶泛著淚。他走到外頭抽菸。隨之而來的沉默中，打火機的點火聲依稀可聞。\n\n代號「布希多」是武器專家，曾在波蘭接受過法國和愛沙尼亞教官的訓練，他告訴我：「兩個才算一個，一個等於沒有。（英文諺語，意指多多益善）」他出任務時，會攜帶至少八個彈匣、四個止血帶、一部無線電、個人急救包、手榴彈、水、無人機干擾器—還有三支手電筒。他的裝備沉重、磨損，但目的明確。被問到他偏愛的武器時，他聳了聳肩，「拿在你手上的那個，就是最好的武器。」\n\n每一次部署展開之前，我們在藏身處的漆黑之中等待。手機的微光映照在疲憊的臉龐上—外面的發電機嗡嗡作響，混雜著遠方傳來發射和來襲火砲的轟隆聲。屋內被寂靜籠罩—輕淺的呼吸聲、偶爾的咳嗽聲、野戰偽裝服摩擦的沙沙聲，以及在陰影之間穿梭的流浪貓的輕聲喵嗚。無線電靜電聲夾雜著指揮中心傳來的最新訊息。\n\n被遺棄的感受真實可觸。川普提出了停火提議卻又陸續撤回，軍隊唯一能信任的，只剩下他們的指揮官。對他們而言，政治只是噪音。美國華府搖擺不定的態度—不管是川普善變的承諾或是歐洲謹慎的外交—感覺太遙遠。唯一要緊的是指揮官的命令。\n\n在外頭，一部探路者（Pathfinder）休旅車已準備就緒。一台無人機掃描儀和對講機放在儀表板上。但這些裝備終究有其侷限。很多無人機飛行時使用的是無法偵測的頻率，而光纖自殺式無人機沒有任何警訊。無人作戰—來自陸、海、空的無人機—已經重新定義這場戰爭。它們執行偵察、打擊和殺戮。車輛架上了無人機干擾器。士兵們改裝電池組，用三Ｄ印表機打造炸彈外殼，並改造商用的裝備。\n\n在二○二四年，烏克蘭總共製造了約二百萬架戰鬥無人機，成為全世界最大的無人機生產國。隨著戰場需求增加國內生產，這個數字在二○二五年預計會提高到四五○萬架。烏克蘭軍方在當地時間六月一日，發動一場精心策劃了十八個月的攻擊行動，行動代號為「蜘蛛網」，透過運達俄羅斯領土的祕密貨櫃，從貨櫃裡成功使用一一七架無人機攻擊俄羅斯五處空軍基地，至少十三架俄國戰機遭破壞，重創俄軍。\n\n在戰場上，敵人可能是一個信號、一個影子，或頭頂上一個咻咻的聲響。這場戰爭不再只是扛著步槍的士兵，那些從天上監視的機器也成了參戰者。\n\n每次任務之前，士兵們要先測試無人機干擾器，為BMP-2戰車準備三○毫米彈帶，給AZP S-60防空炮裝填五七毫米砲彈。其他地方，簡易組成的空中火力—燃燒彈、熱能彈、高爆彈—也準備就緒。電池重新組裝以延長續航距離。無人機作戰不是輔助的戰術。它就是戰爭本身。\n\n不過在高科技的無人機戰爭裡，老舊的蘇聯時期武器在戰場中依然很管用。烏克蘭把所有能拿到的東西都拿來利用—重新整修、改造，然後擊發。\n\nAZP S-60是一九五○年代由蘇聯製造，可由公路運輸的拖式防空炮，曾經在諸多華沙公約國家被廣泛使用。如今在赫爾松，它被重新改造—架在卡車上朝聶伯河對岸開火。原本是為防空而設計，如今用在打擊地面目標。\n\n在一次任務中，兩門AZP S-60防空炮深入零線之內，鎖定目標、已準備朝河的對岸發射。緊接著命令下達：行動取消！行動取消！我們匆忙爬上車。遠方火光四迸。幾秒鐘之後，我們聽到火箭彈從頭頂呼嘯而過，並在更遠處爆炸。我們全速撤離。撤離的速度與混亂，與布署時的精密和謹慎形成強烈對比。\n\n這提醒了我們：零線順著它的律動變化。計畫在轉瞬間會有變動。即使是最精心布設的武器，也可能隨砲火來襲而消聲匿跡。接著，同樣在頃刻間，下一個任務又開始了。\n\n往零線前進的路上，我們行經一路廢墟：纏結的灌溉管線、傾倒的住家、遠方飄著濃煙。我以為是火箭彈，結果是一部燃燒中的卡車。不過我們明白它的信號。地平線上的閃光意味著有火箭來襲。光速總是快於聲音。短短幾秒內，一架嗡嗡打轉的除草機—FPV自殺無人機—就可從天而降，撞擊地面，隨後是如鋼鐵在熔爐內炸裂的轟然巨響，迴盪在開闊的原野。但我們持續行進。速度加快，身體壓低。\n\n有一次，我看到一艘被拖上岸的橡皮艇裡頭，士兵們正在查看林木線，同時間其他士兵則手持步槍進行掩護。他們知道每次渡河都有喪命的風險。回到藏身處之後，在僅有微弱紅色頭燈的黑暗中，他們抽菸抽個不停，然後喝水、把水倒在頭頂上。這是一種儀式。一種紓解的動作。\n\n零線不只是一個新聞標題。它是我所見所聞，它是我生活過的所在。它是介於光明和黑暗、分隔已許的承諾和未履行的援助之間的界線。烏克蘭不是為某種象徵意義而戰。它為生存而戰。它是軍靴踩在毀棄田野的嘎茲聲。它是漆黑藏身處的手機螢幕亮光。它是火箭發射前的寂靜。它的記憶被現實磨得傷痕累累。\n\n自俄羅斯從二○二二年入侵烏克蘭以來，我已經十度自費走訪戰事前線。我在烏克蘭所見證的，很可能預示我們眼前的未來。赫爾松和台北的距離，不管在戰略上或在實存上，都比想像還要近。\n\n這樣的感受，在二○二五年七月四日俄羅斯發動開戰以來最大規模的無人機和飛彈聯合攻擊後，變得益發強烈：一天之內，有五三九架無人機與十一枚飛彈襲擊烏克蘭全境。這次的攻擊，就發生在美國總統川普與俄羅斯總統普丁通電話的數小時之後。雖然二者間的關聯性無從確認，不過多家媒體都指出了這時間點的巧合。台灣社會多少也有「烏克蘭疲勞」，人們對戰爭消息有種遙遠、不及人身的感受。身為深入過零線的見證者，當天早上聽到這個消息時，我不禁心頭一沉。所有的記憶瞬間湧現—無人機的嗡鳴、地面的震動，以及難以忍受的等待。\n\n我只盼望同樣的狀況，永遠不會發生在台灣。`,
            },
          ],
        },

...
const htmlMeta = {
  ...
  eng_text: {
    title: 'Fight or Flee: The Price of Freedom',
  },
}
...
firstPage = {
  ...
  eng_text: {
    title:
      'Fight or Flee: The Price of Freedom\nChien-Chi Chang’s Three-Year Chronicle of the Russia-Ukraine War'.replace(
        /’/g,
        "'"
      ),
    foreword: '',
  ...
  .reduce((first) => {
    return {
      ...
      eng_text: {
        ...
        second: {
          title:
            'Fight or Flee: The Price of Freedom\nChien-Chi Chang’s Three-Year'.replace(
              /’/g,
              "'"
            ),
          pairs: [
        ...
        credit: {
          pairs: [
            ...
            'Wen-Han Lee, Yi-Hsuan Lee, Lee-Yu Tseng, Yu-Ju Lee, Hsin-Chan Chien',
